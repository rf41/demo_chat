...
for message in st.session_state.messages:
    if message["role"] == "bot":
        # Create styled container with direct HTML/CSS
        st.markdown("""
        <div style="background-color: #f0f0f0; border-left: 5px solid #4CAF50; padding: 1rem; 
        border-radius: 0.5rem; margin-bottom: 1rem;">
            <div style="font-size: 0.8rem; color: #888; margin-bottom: 0.5rem;">Bot</div>
            <div id="bot-content"></div>
        </div>
        """, unsafe_allow_html=True)
        
        # Display markdown content separately to preserve formatting
